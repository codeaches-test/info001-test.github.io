...
keywords: spring security,spring security example,spring security tutorial,spring security oauth2,spring security jwt,spring security json web token,spring boot,codeaches 
...
> Both john and kelly have access to `/pet`
